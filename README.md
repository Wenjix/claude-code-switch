...
[![Platform](https://img.shields.io/badge/Platform-macOS%20%7C%20Linux-blue.svg)](https://github.com/Wenjix/claude-code-switch)
...
```bash
# 1. Install
curl -fsSL https://raw.githubusercontent.com/Wenjix/claude-code-switch/main/quick-install.sh | bash
...
```bash
git clone https://github.com/Wenjix/claude-code-switch.git
...
📧 Questions or suggestions? Feel free to submit an [Issue](https://github.com/Wenjix/claude-code-switch/issues)
